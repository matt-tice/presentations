...
\maketitle
\begin{frame}[label={sec:org76bac06}]{Main Results}
...
\end{proposition}
\end{frame}
\begin{frame}[label={sec:org55250ed}]{Main Results (Properad Version)}
...
\end{proposition}
\end{frame}
\begin{frame}[label={sec:orge55537a},fragile]{Generators and Relations}
...
\]
\end{frame}
\begin{frame}[label={sec:org6ddaed5}]{Explicit Form (infinite distributivity)}
...
\]
\end{frame}
\begin{frame}[label={sec:orgbca468b}]{Precursors}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1240079},fragile]{Orthogonal Categories}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdc1242b}]{Causality}
...
whenever \(f \perp g\).
\end{frame}
\begin{frame}[label={sec:orga817759}]{Introducing Homotopy}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org678e101}]{Pointwise A\textsubscript{\(\infty\)}-algebras}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgda889de}]{Alternatives}
...
\begin{itemize}
\item This is an easier model for performing computations
\end{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org447bf1d},fragile]{Hopf-Laplace Algebras}
...
\end{frame}
\begin{frame}[label={sec:org0338129}]{Properad of Laplace Hopf AQFTs}

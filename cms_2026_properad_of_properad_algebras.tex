...
\maketitle
\begin{frame}[label={sec:orgedebb86}]{Main Results}
...
\end{proposition}
\end{frame}
\begin{frame}[label={sec:orgc734555}]{Main Results (Properad Version)}
...
\end{proposition}
\end{frame}
\begin{frame}[label={sec:org0c6026d},fragile]{Generators and Relations}
...
\]
\end{frame}
\begin{frame}[label={sec:org7ca90df}]{Explicit Form (infinitary distributivity)}
...
\]
\end{frame}
\begin{frame}[label={sec:org0fe3717}]{Precursors}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdfe2e91},fragile]{Orthogonal Categories}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4db4b31}]{Causality}
...
whenever \(f \perp g\).
\end{frame}
\begin{frame}[label={sec:org9287a6d}]{Introducing Homotopy}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2ba2175}]{Pointwise A\textsubscript{\(\infty\)}-algebras}
...
\end{frame}
\begin{frame}[label={sec:org0fe772c}]{Pointwise A\textsubscript{\(\infty\)}-algebras}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1182c94}]{Hopf-Laplace Algebras}
\end{frame}

\begin{frame}[label={sec:orge51f994}]{Properad of Laplace Hopf AQFTs}
